...
public class BoardMapperTests {
	 ...
	 * 
	 * //존재하는 게시물 번호로 테스트 BoardVO board = mapper.read(6L);
	 * 
	 * log.info(board); }
	 * 
	 ...
	 * 
	 * BoardVO board = new BoardVO(); board.setBno(7L); board.setTitle("수정된 제목");
	 * board.setContent("수정된 내용"); board.setWriter("user00");
	 * 
	 * int count = mapper.update(board); log.info("updateCount = "+ count); }
	 */
