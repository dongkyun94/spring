...
public class BoardControllerTests {
	 ...
	 * .perform(MockMvcRequestBuilders.post("/board/modify") .param("bno", "22")
	...
	public void testRemove() throws Exception {
		//삭제전 DB 게시물 확인
		String reustlPage = mockMvc.perform(MockMvcRequestBuilders.post("/board/remove")
